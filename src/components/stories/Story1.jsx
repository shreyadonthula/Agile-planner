...
const Story1 = () => {
    const [storypoints,setstorypoints]=useState('');
      ...
      // console.log(localStorage.getItem('storysizeInLocalStorage'));
      React.useEffect(()=>{
        localStorage.setItem('storypoints',storypoints)
      })
  onchange=(e)=>{
    ...
    return (  
        ...
        <div className="story-size">
            ...
            <p>Story points:
            <Input  placeholder="storypoints" type="text" value={storypoints} onChange={onchange}   required/>
